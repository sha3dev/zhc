...
description: Builds APIs, manages data, and implements business logic — server-side architecture, databases, auth, security, and the foundation the Frontend Engineer consumes.
model:
---
