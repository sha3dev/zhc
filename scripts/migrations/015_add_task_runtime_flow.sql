...
COMMENT ON COLUMN task.tsk_has_dependency_risk IS 'True when an upstream task re-entered review and may invalidate this task';
...
COMMENT ON COLUMN task_event.tev_kind IS 'Event kind: assignment, ceo_instruction, agent_reply, submission, approval, changes_requested, blocked, status_changed, dependency_risk_flagged';
